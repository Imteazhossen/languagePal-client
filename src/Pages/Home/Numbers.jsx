...
const Numbers = () => {
    return (
        <div className='my-10'>
            <div>
            <h1 className= 'text-2xl md:text-4xl  text-sky-500 font-bold text-center '>We Provide Best Teachers For You</h1>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-10 md:px-25 py-10'>
              <div className="rounded-2xl h-[140px] flex flex-col justify-center items-center  bg-emerald-100 p-5" >
                ...
                <h1 className='text-left text-4xl  md:text-6xl font-bold'><CountUp end={10}  duration={20}></CountUp>+</h1>
              ...
              <div className="rounded-2xl h-[140px]  flex flex-col justify-center items-center bg-sky-100 p-5" >
                ...
                <h1 className='text-left  text-4xl md:text-6xl font-bold'><CountUp end={105}  duration={20}></CountUp>+</h1>
                <p className='mt-5 text-left text-gray-500 font-semibold'>Tutor reviews</p>
              </div>
              <div className="rounded-2xl h-[140px] flex flex-col justify-center items-center bg-emerald-100 p-5" >
             
                <h1 className='text-left text-4xl md:text-6xl font-bold'><CountUp end={8}  duration={20}></CountUp>+</h1>
