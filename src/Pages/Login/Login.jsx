                ...
                <div className="hero-content gap-10 flex-col lg:flex-row">
                    ...
                    <div className="card bg-emerald-50 w-full max-w-md shrink-0 shadow-2xl">
                        <div className="card-body">
                            <h1 className="text-4xl font-bold text-gray-600 text-center">Login!</h1>
                            ...
                            <button onClick={handleGoogleSignIn} className="btn bg-base-100 text-base-content border border-gray-300 w-full">
